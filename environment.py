...
class Environment:
    ...
    def __init__(self):
        ...
        self.nRows = 6
        self.nColumns = 11
        self.rewards = [-3, -10, 1000, -20000,
                        -20]  # living penalty, hitting wall, finish line, fire pit, getting towards fire
    ...
    def drawScreen(self, inx, pos):
        ...
        if self.playerPos != -1:
            self.screen.blit(self.sprites[0], (
                (self.playerPos % self.nColumns) * self.cellWidth,
                int(self.playerPos / self.nColumns) * self.cellHeight))
